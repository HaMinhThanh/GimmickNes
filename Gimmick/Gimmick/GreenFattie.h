...
#define FATTIE_SPEED_X				0.08f
#define FATTIE_SPEED_Y_NORMAL			0.25f
#define FATTIE_SPEED_Y_DAMAGED			0.17f
...
#define FATTIE_BBOX_WIDTH	32
#define FATTIE_BBOX_HEIGHT	32

#define BOMB_MAX_DISTANCE_WITH_GIMMICK	52
#define BOMB_JUMP_ALIGN		5

class CGreenFattie : public CGameObject
{
public:
...
public:
	...
	int damaged = 0;
	CGreenFattie(float x, float y, int item);
	~CGreenFattie();
	...
	void Jumping() { vy = FATTIE_SPEED_Y_NORMAL; }
